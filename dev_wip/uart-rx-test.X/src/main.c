 ...
 *   em RC0/RC1, pisca o LED de TX em RB14 e pisca o
 *   LED de RX em RB15 por 1 s quando qualquer dado
 *   chega pela UART.
 */
...
int main(void)
{
    ...
    while (operation)
    {
        ...
        // Pisca o LED de TX para sinalizar o envio.
        blink_led();

        // Aguarda o restante do ciclo de 10 s, mantendo a verificacao do RX.
        for (i = 0u; i < (uint32_t)(CICLO_MS - BLINK_MS); i++)
        {
            delay_ms(1);
            uart1_rx_poll();
